    ...
    return (
        <div className="work-experience">
            ...
            <div className="work-experience__item">
                ...
                <p className="work-experience__duration">Duration: Month Year - Month Year</p>
                <p className="work-experience__description">Brief description of responsibilities and achievements.</p>
            </div>
            <div className="work-experience__item">
